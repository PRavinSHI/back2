...
__help__ = """
*Admins only:*
☼︎ /welcome <on/off>*:* enable/disable welcome messages.
☼︎ /welcome*:* shows current welcome settings.
☼︎ /welcome noformat*:* shows current welcome settings, without the formatting - useful to recycle your welcome messages!
☼︎ /goodbye*:* same usage and args as `/welcome`.
☼︎ /setwelcome <sometext>*:* set a custom welcome message. If used replying to media, uses that media.
☼︎ /setgoodbye <sometext>*:* set a custom goodbye message. If used replying to media, uses that media.
☼︎ /resetwelcome*:* reset to the default welcome message.
☼︎ /resetgoodbye*:* reset to the default goodbye message.
☼︎ /cleanwelcome <on/off>*:* On new member, try to delete the previous welcome message to avoid spamming the chat.
☼︎ /welcomemutehelp*:* gives information about welcome mutes.
☼︎ /cleanservice <on/off*:* deletes telegrams welcome/left service messages.
 *Example:*
user joined chat, user left chat.
*Welcome markdown:*
☼︎ /welcomehelp*:* view more formatting information for custom welcome/goodbye messages.
"""
