...
☼︎ /cleanblue <on/off/yes/no>*:* clean commands after sending
☼︎ /ignoreblue <word>*:* prevent auto cleaning of the command
☼︎ /unignoreblue <word>*:* remove prevent auto cleaning of the command
☼︎ /listblue*:* list currently whitelisted commands

 *Following are Disasters only commands, admins cannot use these:*

☼︎ /gignoreblue <word>*:* globally ignorea bluetext cleaning of saved word across Saitama.
☼︎ /ungignoreblue <word>*:* remove said command from global cleaning list
"""
