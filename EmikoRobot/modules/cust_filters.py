...
__help__ = """
☼︎ /filters*:* List all active filters saved in the chat.
*Admin only:*
☼︎ /filter <keyword> <reply message>*:* Add a filter to this chat. The bot will now reply that message whenever 'keyword'\
...
☼︎ /stop <filter keyword>*:* Stop that filter.

*Chat creator only:*

☼︎ /removeallfilters*:* Remove all chat filters at once.
