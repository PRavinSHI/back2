...
__help__ = """
*User Commands*:
☼︎ /admins*:* list of admins in the chat
☼︎ /pinned*:* to get the current pinned message.
...
☼︎ /promote*:* promotes the user replied to
☼︎ /fullpromote*:* promotes the user replied to with full rights
☼︎ /demote*:* demotes the user replied to
☼︎ /title <title here>*:* sets a custom title for an admin that the bot promoted
☼︎ /admincache*:* force refresh the admins list
...
☼︎ /setgtitle <text>*:* set group title
☼︎ /setgpic*:* reply to an image to set as group photo
☼︎ /setdesc*:* Set group description
☼︎ /setsticker*:* Set group sticker

*Rules*:
☼︎ /rules*:* get the rules for this chat.
☼︎ /setrules <your rules here>*:* set the rules for this chat.
☼︎ /clearrules*:* clear the rules for this chat.
"""
