...
☼︎ /locktypes*:* Lists all possible locktypes

*Admins only:*
☼︎ /lock <type>*:* Lock items of a certain type (not available in private)
☼︎ /unlock <type>*:* Unlock items of a certain type (not available in private)
☼︎ /locks*:* The current list of locks in this chat.
...
*Note:*
☼︎ Unlocking permission *info* will allow members (non-admins) to change the group information, such as the description or the group name
☼︎ Unlocking permission *pin* will allow members (non-admins) to pinned a message in a group
"""
